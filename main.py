"""
main.py — Phase 3B: Offline Tuning & Walk-Forward Harness

Run this to kick off the Planner → Executor → Evaluator cycle for Phase 3B.
...
def main() -> None:
    ...
    try:
        ...
        print(f"\nPhase 3B complete in {result.rounds_taken} round(s).")
